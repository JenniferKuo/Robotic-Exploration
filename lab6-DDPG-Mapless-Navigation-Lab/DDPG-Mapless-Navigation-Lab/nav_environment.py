...
class NavigationEnv:
    ...
    def step(self, action):
        ...
        # Distance Reward: The reduction of distance from car to navigate target. 
        ...
        # Orientation Reward: Penalty for the angle between forward direction and target direction. 
        ...
        # Action Panelty: Penalty for small movement
        reward_act = 0.05 if action[0] < -0.5 else 0
        
        # Total: Total reward is the weighted sum of the above three rewards. 
        w1 = w2 =  w3 = 1
